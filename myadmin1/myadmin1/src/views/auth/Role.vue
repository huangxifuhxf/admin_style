<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <el-button @click='addDialogVisible = true' type="primary" plain>添加角色</el-button>
      </el-col>
    </el-row>
    <el-table @expand-change="toggleRow" border: border :data="tableData" stripe style="width: 100%" class="mt-15 mb-15">
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-row :key="item.id" v-for="item in props.row.children">
            <el-col :span="3">
